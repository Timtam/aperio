          ...
          <form onSubmit={onSubmit} className="form">
            ...
            <div className="form__actions">
              ...
              {(formSpec?.actions ?? []).map((action) => (
                ...
                {/* The core decides: an adapter that signs in purely by OAuth
                  has nothing a probe could use, because its credential is a
                  token the sign-in produces and the sign-in has not happened.
                  The kind list that used to stand here is gone — every adapter
                  that reached it declares a schema now, so it only said the
                  same thing twice. */}
