 ...
 * every time the user presses Ctrl+1/2/3 to switch views, even
 * though the local SQLite backend returns events in well under
 * 100 ms. Adding a small delay before flipping the indicator on
 * means:
 *
