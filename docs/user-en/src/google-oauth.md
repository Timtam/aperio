# Connecting Google – your own OAuth credentials (interim guide)
...
> [device synchronization](tutorial/08-synchronisation.md) through Google
...
> [end-to-end encryption](tutorial/08-synchronisation.md) enabled they
