# Google einbinden – eigene OAuth-Zugangsdaten (Übergangslösung)
...
> [Geräte-Synchronisation](tutorial/08-synchronisation.md) über Google Drive
...
> aktivierter [E2E-Verschlüsselung](tutorial/08-synchronisation.md) wandern
