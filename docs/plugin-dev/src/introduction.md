...
|---|---|
| [Getting Started](getting-started.md) | Build a working minimal plugin in under 15 minutes. |
| [The C ABI](abi-reference.md) | The full contract: structs, lifecycle, vtables, memory rules, versioning. |
| [The Rust SDK](rust-sdk.md) | The macros and helpers that hide the FFI. |
| [The manifest](manifest.md) | Every `plugin.json` field. |
| [Examples](examples/index.md) | `hello-world` and a full calendar-adapter template. |
