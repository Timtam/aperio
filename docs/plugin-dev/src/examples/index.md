...
- **[hello-world](hello-world.md)** — the absolute minimum: a
...
- **[calendar-adapter-template](calendar-adapter-template.md)** — a full
  scaffold for a real calendar adapter, with every method present as a stub
  and inline comments pointing at what to fill in.

Both follow the structure from [The Rust SDK](rust-sdk.md): a library crate
