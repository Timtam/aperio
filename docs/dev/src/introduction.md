# Aperio — Developer Documentation
...
|---|---|
| [Getting Started](getting-started.md) | Prerequisites, cloning, running a dev build, the commands you'll use daily. |
| [Architecture](architecture.md) | How the host, frontend, and plugin system fit together; the data and sync paths. |
| [Contributing](contributing.md) | Branching, commits, the accessibility-as-a-gate rule, code style. |
| [Testing](testing.md) | Unit and adapter tests, the accessibility test matrix, CI. |
| [Adapters](adapters/overview.md) | Per-provider notes: protocol, auth, quirks, how to test. |
