...
public protocol HostProtocol: AnyObject, Sendable {
     ...
     */
    func acceptRemoteDatasetValuesJson(requestJson: String, deviceName: String?, passphrase: String?) throws  -> String
     ...
     */
    func accountsJson(lang: String?) throws  -> String
     ...
     */
    func adoptLocalDatasetValuesJson(requestJson: String, deviceName: String?, passphrase: String?) throws  -> String
     ...
     */
    func createDayMarkerJson(name: String, symbol: String?, colorLabel: String?) throws  -> String
     ...
     * event_id}` objects.
     */
    func declineGroupSuggestionJson(firstJson: String, secondJson: String) throws 
    ...
    func deleteDayMarker(id: String) throws 
     ...
     */
    func dissolveEventGroup(groupId: String) throws 
     ...
     */
    func eventGroupsForEventsJson(eventsJson: String) throws  -> String
     ...
     */
    func eventLocalRemindersJson() throws  -> String
    
    /**
     * The meeting Aperio created for this event, if any, as JSON.
     */
    func eventMeetingJson(eventId: String, calendarId: String?) throws  -> String
     ...
     */
    func groupEventsJson(membersJson: String) throws  -> String
    
    /**
     * Every pair the user has said is not one appointment, as JSON.
     */
    func groupSuggestionDeclinesJson() throws  -> String
     ...
     */
    func healEventLocalReminders(calendarId: String, oldEventId: String, newEventId: String) throws  -> Bool
     ...
     */
    func listAccountsMissingCredentialsJson(lang: String?) throws  -> String
     ...
     */
    func listAdapterKindsJson(lang: String?) throws  -> String
     ...
     */
    func listDayMarkersJson() throws  -> String
     ...
     */
    func previewSyncTargetValuesJson(requestJson: String) throws  -> String
     ...
     */
    func refreshEventLocalReminderSignature(calendarId: String, eventId: String, title: String, startsAt: String) throws 
     ...
     * caller ever read it.
     */
    func reparentTaskList(id: String, parentId: String?) throws 
     ...
     */
    func setDayLogJson(logJson: String) throws  -> String
     ...
     */
    func setEventLocalRemindersJson(calendarId: String, eventId: String, remindersJson: String, title: String, startsAt: String) throws  -> String
     ...
     */
    func ungroupEventJson(calendarId: String, eventId: String, bookkeeping: Bool) throws  -> String?
     ...
     */
    func updateDayMarkerJson(markerJson: String) throws  -> String
...
open func acceptRemoteDatasetJson(configJson: String, deviceName: String?, passphrase: String?)throws  -> String  {
     ...
     * not leave the device in two different states.
     */
open func acceptRemoteDatasetValuesJson(requestJson: String, deviceName: String?, passphrase: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_accept_remote_dataset_values_json(
            self.uniffiCloneHandle(),
...
open func accountFormSpecJson(adapterKind: String, lang: String?)throws  -> String  {
     ...
     * out its kind string instead. Empty `lang` means English.
     */
open func accountsJson(lang: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
...
open func adoptLocalDatasetJson(configJson: String, deviceName: String?, passphrase: String?)throws  -> String  {
     ...
     * dataset rather than an error — encryption can be turned on afterwards.
     */
open func adoptLocalDatasetValuesJson(requestJson: String, deviceName: String?, passphrase: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_adopt_local_dataset_values_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(requestJson),
        FfiConverterOptionString.lower(deviceName),
        FfiConverterOptionString.lower(passphrase),$0
...
open func createContactListJson(name: String)throws  -> String  {
     ...
     * Add a marker; returns the created `DayMarker` as JSON.
     */
open func createDayMarkerJson(name: String, symbol: String?, colorLabel: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_create_day_marker_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(name),
        FfiConverterOptionString.lower(symbol),
...
open func customSoundPath(sha256: String)throws  -> String?  {
     ...
     * never null — the callers render the same thing either way.
     */
open func dayLogJson(day: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_day_log_json(
            self.uniffiCloneHandle(),
     ...
     * for once, instead of one call per day.
     */
open func dayLogsInRangeJson(from: String, to: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_day_logs_in_range_json(
            self.uniffiCloneHandle(),
     ...
     * event_id}` objects.
     */
open func declineGroupSuggestionJson(firstJson: String, secondJson: String)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_decline_group_suggestion_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(firstJson),
        FfiConverterString.lower(secondJson),$0
    )
}
}
...
open func deleteDayMarker(id: String)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_delete_day_marker(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(id),$0
    )
}
...
open func discoverJson(pluginId: String, argsJson: String)throws  -> String  {
     ...
     * Dissolve a whole group. The events themselves are untouched.
     */
open func dissolveEventGroup(groupId: String)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_dissolve_event_group(
            self.uniffiCloneHandle(),
...
open func enableSyncEncryptionJson(passphrase: String)throws  -> String  {
     ...
     * whole ("this and three others").
     */
open func eventGroupsForEventsJson(eventsJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_event_groups_for_events_json(
            self.uniffiCloneHandle(),
     ...
     * reminder Aperio keeps to itself.
     */
open func eventLocalRemindersJson()throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_event_local_reminders_json(
            self.uniffiCloneHandle(),$0
    )
})
}
     ...
     * The meeting Aperio created for this event, if any, as JSON.
     */
open func eventMeetingJson(eventId: String, calendarId: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
...
open func getUserPref(key: String)throws  -> String?  {
     ...
     * whose provider id changes can be found again.
     */
open func groupEventsJson(membersJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_group_events_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(membersJson),$0
    )
})
}
     ...
     * Every pair the user has said is not one appointment, as JSON.
     */
open func groupSuggestionDeclinesJson()throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_group_suggestion_declines_json(
            self.uniffiCloneHandle(),$0
    )
})
}
     ...
     * `EventRemindersRepo::heal`.
     */
open func healEventLocalReminders(calendarId: String, oldEventId: String, newEventId: String)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_heal_event_local_reminders(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(calendarId),
        FfiConverterString.lower(oldEventId),
        FfiConverterString.lower(newEventId),$0
    )
})
}
...
open func isDeviceAccount(accountId: String) -> Bool  {
     ...
     * and a row without a name reads out its kind string.
     */
open func listAccountsMissingCredentialsJson(lang: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
     ...
     * `account_form_spec_json` next door uses.
     */
open func listAdapterKindsJson(lang: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
...
open func listCustomSoundsJson()throws  -> String  {
     ...
     * The marker vocabulary as a JSON `DayMarker[]`, in the user's order.
     */
open func listDayMarkersJson()throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_list_day_markers_json(
            self.uniffiCloneHandle(),$0
    )
})
}
...
open func listSyncLogJson(limit: UInt32)throws  -> String  {
     ...
     * typo in the diagnostic is the worst possible trade.
     */
open func logLine(level: String, message: String)  {try! rustCall() {
    uniffi_cal_ffi_fn_method_host_log_line(
            self.uniffiCloneHandle(),
...
open func previewSyncTargetJson(configJson: String)throws  -> String  {
     ...
     * gesture, exactly as the account picker does.
     */
open func previewSyncTargetValuesJson(requestJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_preview_sync_target_values_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(requestJson),$0
    )
})
...
open func refreshErrorsJson()throws  -> String  {
     ...
     * matching after a rename or a move. Local and silent, like the repair.
     */
open func refreshEventLocalReminderSignature(calendarId: String, eventId: String, title: String, startsAt: String)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_refresh_event_local_reminder_signature(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(calendarId),
        FfiConverterString.lower(eventId),
        FfiConverterString.lower(title),
        FfiConverterString.lower(startsAt),$0
    )
}
}
...
open func renameContainer(containerId: String, kind: String, name: String)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
     ...
     * caller ever read it.
     */
open func reparentTaskList(id: String, parentId: String?)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_reparent_task_list(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(id),
...
open func setContainerColorLabel(containerId: String, kind: String, colorLabelId: String?)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
     ...
     * last one" reaches the other device.
     */
open func setDayLogJson(logJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_set_day_log_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(logJson),$0
    )
})
}
...
open func setEventColor(eventId: String, calendarId: String, colorLabelId: String?)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
     ...
     * JSON. Mirrors the desktop `set_event_local_reminders`.
     */
open func setEventLocalRemindersJson(calendarId: String, eventId: String, remindersJson: String, title: String, startsAt: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_set_event_local_reminders_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(calendarId),
        FfiConverterString.lower(eventId),
        FfiConverterString.lower(remindersJson),
        FfiConverterString.lower(title),
        FfiConverterString.lower(startsAt),$0
    )
})
...
open func trustSftpHostKey(hostPort: String, fingerprint: String)throws   {try rustCallWithError(FfiConverterTypeStoreError_lift) {
     ...
     * its way straight back into the new group.
     */
open func ungroupEventJson(calendarId: String, eventId: String, bookkeeping: Bool)throws  -> String?  {
    return try  FfiConverterOptionString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_ungroup_event_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(calendarId),
        FfiConverterString.lower(eventId),
        FfiConverterBool.lower(bookkeeping),$0
    )
})
}
...
open func updateContactJson(contactJson: String)throws  -> String  {
     ...
     * one call, so the frontend needs one code path for all four.
     */
open func updateDayMarkerJson(markerJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_method_host_update_day_marker_json(
            self.uniffiCloneHandle(),
        FfiConverterString.lower(markerJson),$0
    )
})
}
 ...
 */
public func carryOntoFields(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_carry_onto_fields(
        FfiConverterString.lower(inputJson),$0
    )
})
}
public func collapseEventGroups(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_collapse_event_groups(
        FfiConverterString.lower(inputJson),$0
    )
})
}
 ...
 */
public func compareNames(a: String, b: String, languageTag: String) -> Int32  {
    return try!  FfiConverterInt32.lift(try! rustCall() {
    uniffi_cal_ffi_fn_func_compare_names(
 ...
 */
public func compareTitles(a: String, b: String, languageTag: String) -> Int32  {
    return try!  FfiConverterInt32.lift(try! rustCall() {
    uniffi_cal_ffi_fn_func_compare_titles(
        FfiConverterString.lower(a),
        FfiConverterString.lower(b),
        FfiConverterString.lower(languageTag),$0
    )
 ...
 */
public func detectConference(sourcesJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_detect_conference(
        FfiConverterString.lower(sourcesJson),$0
    )
})
}
/**
 ...
 */
public func findGroupSuggestions(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_find_group_suggestions(
        FfiConverterString.lower(inputJson),$0
    )
})
}
public func findMeetingLinkPairs(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_find_meeting_link_pairs(
        FfiConverterString.lower(inputJson),$0
    )
})
}
 ...
 */
public func futureCarryFields(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_future_carry_fields(
        FfiConverterString.lower(inputJson),$0
    )
})
}
 ...
 */
public func isImportantPriority(priority: String)throws  -> Bool  {
    return try  FfiConverterBool.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_is_important_priority(
        FfiConverterString.lower(priority),$0
    )
})
}
/**
 ...
 */
public func normalPriority(previous: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_normal_priority(
        FfiConverterString.lower(previous),$0
    )
})
}
/**
 ...
 */
public func normalizeJoinUrl(url: String) -> String  {
    return try!  FfiConverterString.lift(try! rustCall() {
    uniffi_cal_ffi_fn_func_normalize_join_url(
 ...
 */
public func occurrenceCarryFields(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_occurrence_carry_fields(
        FfiConverterString.lower(inputJson),$0
    )
})
}
 ...
 */
public func planCarry(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_plan_carry(
        FfiConverterString.lower(inputJson),$0
    )
})
}
 ...
 */
public func priorityRank(priority: String, scale: String)throws  -> UInt32  {
    return try  FfiConverterUInt32.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_priority_rank(
        FfiConverterString.lower(priority),
        FfiConverterString.lower(scale),$0
    )
})
}
/**
 ...
 */
public func suggestGroupMate(inputJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_suggest_group_mate(
        FfiConverterString.lower(inputJson),$0
    )
})
}
...
public func withoutDuplicateMeetings(eventsJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeStoreError_lift) {
    uniffi_cal_ffi_fn_func_without_duplicate_meetings(
        FfiConverterString.lower(eventsJson),$0
    )
})
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_cal_ffi_checksum_func_carry_onto_fields() != 62986) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_collapse_event_groups() != 10030) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_compare_names() != 26485) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_compare_titles() != 57834) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_detect_conference() != 16331) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_find_group_suggestions() != 11457) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_find_meeting_link_pairs() != 33200) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_future_carry_fields() != 52339) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_is_important_priority() != 30160) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_normal_priority() != 55182) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_normalize_join_url() != 65229) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_occurrence_carry_fields() != 22714) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_parse_attendee() != 55709) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_plan_carry() != 50058) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_priority_rank() != 622) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_rrule_to_task_recurrence() != 23397) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_suggest_group_mate() != 60991) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_task_recurrence_to_rrule() != 25991) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_func_without_duplicate_meetings() != 42105) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_accept_remote_dataset_values_json() != 40519) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_account_form_spec_json() != 10110) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_accounts_json() != 28282) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_adopt_local_dataset_values_json() != 62805) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_create_day_marker_json() != 9491) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_day_log_json() != 14823) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_day_logs_in_range_json() != 44584) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_decline_group_suggestion_json() != 11878) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_delete_day_marker() != 51422) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_dissolve_event_group() != 23036) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_enable_sync_encryption_json() != 14292) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_event_groups_for_events_json() != 35375) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_event_local_reminders_json() != 54488) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_event_meeting_json() != 34444) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_group_events_json() != 28956) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_group_suggestion_declines_json() != 47) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_heal_event_local_reminders() != 57037) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_list_accounts_missing_credentials_json() != 51455) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_cal_ffi_checksum_method_host_list_adapter_kinds_json() != 10914) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_list_day_markers_json() != 34183) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_log_line() != 17206) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_preview_sync_target_values_json() != 54953) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_refresh_event_local_reminder_signature() != 23111) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_reparent_task_list() != 29027) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_set_day_log_json() != 55253) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_set_event_local_reminders_json() != 60593) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_task_lists_json() != 15879) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_ungroup_event_json() != 24713) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_cal_ffi_checksum_method_host_update_day_marker_json() != 6220) {
        return InitializationResult.apiChecksumMismatch
    }
