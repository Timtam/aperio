...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        target: 29,
        sql: include_str!("sql/0029_event_recurrence_tzid.sql"),
    },
    Migration {
        target: 30,
        sql: include_str!("sql/0030_task_effort.sql"),
    },
    Migration {
        target: 31,
        sql: include_str!("sql/0031_task_deadline_reminder_days.sql"),
    },
    Migration {
        target: 32,
        sql: include_str!("sql/0032_cache_sections.sql"),
    },
    Migration {
        target: 33,
        sql: include_str!("sql/0033_cache_refresh_failure_count.sql"),
    },
    Migration {
        target: 34,
        sql: include_str!("sql/0034_event_meetings.sql"),
    },
    Migration {
        target: 35,
        sql: include_str!("sql/0035_event_groups.sql"),
    },
    Migration {
        target: 36,
        sql: include_str!("sql/0036_event_group_tombstones.sql"),
    },
    Migration {
        target: 37,
        sql: include_str!("sql/0037_event_group_suggestion_declines.sql"),
    },
    Migration {
        target: 38,
        sql: include_str!("sql/0038_suggestion_decline_cleared.sql"),
    },
    Migration {
        target: 39,
    ...
    Migration {
        target: 41,
        sql: include_str!("sql/0041_day_markers.sql"),
    },
    Migration {
        target: 42,
        sql: include_str!("sql/0042_contact_name_affixes.sql"),
    },
    Migration {
        target: 43,
        sql: include_str!("sql/0043_event_local_reminders.sql"),
    },
    Migration {
        target: 44,
        sql: include_str!("sql/0044_event_color_override_signature.sql"),
    },
];
