...
2. Lege eine Aufgabe an: **Aufgabe schnell anlegen** (`Alt+N`) öffnet den
   Schnell-Dialog — auch dort werden dir frühere Einträge angeboten, und
   nimmst du einen an, öffnet sich der bereits ausgefüllte Editor, **Neue Aufgabe** (`Alt+Umschalt+N`) das vollständige Formular.
...
- **Einplanen:** Gib einer Aufgabe ein Fälligkeitsdatum (oder ziehe sie in
  der Wochenplanung auf einen Tag), um sie fest einzuplanen. Der schnellste Weg
  ist **Einplanen** im Kontextmenü jeder Aufgabe (Rechtsklick,
  `Umschalt+F10`, am Telefon langer Druck bzw. Rotor-Aktion) – oder
  `Umschalt+D` auf der fokussierten Aufgabe.
...
> geblieben ist, ist damit mit **einem** Haken wieder im Takt: die von gestern
> heute Morgen abgehakt lässt die **heutige** stehen, und nur die. Bei einer
> monatlichen Aufgabe – Miete zum Ersten, die Juli-Miete am 2. August abgehakt –
> ist die nächste Fälligkeit der **1. August**: einen Tag überfällig, aber
> sichtbar, statt dass ein ganzer Monat lautlos ausfällt. Mehr als **einen**
> zusätzlichen Haken kostet das Aufholen nie.
>
> Die abgehakte Aufgabe bleibt an **ihrem geplanten Tag** stehen – im Kalender
> behält damit jeder Tag genau seinen Durchgang, statt dass sich alles auf dem
> Tag des Hakens sammelt.
...
- Der **Tagesbeginn-Überblick** schlägt dir nur Aufgaben vor, die **dir oder
  ...
  Trägt eine Liste verpasste Aufgaben von selbst auf heute oder in den Backlog,
  wandern auch nur Unteraufgaben mit, die **dir oder niemandem** gehören – die
  Unteraufgabe einer anderen Person behält ihren Tag.
